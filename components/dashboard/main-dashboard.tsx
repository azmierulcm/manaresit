...
const CashflowChart = dynamic(
  () => import("@/components/dashboard/dashboard-charts").then((m) => m.CashflowChart),
  { ssr: false, loading: () => <Skeleton className="h-64 w-full" /> },
);
const CategoryChart = dynamic(
  () => import("@/components/dashboard/dashboard-charts").then((m) => m.CategoryChart),
...
// CashflowChart and CategoryChart are lazy-loaded from dashboard-charts.tsx
